    ...
    <div class="container">
        <div class="box form-box">
            ...
            if (isset($_POST['submit'])) {
                ...
                $result = mysqli_query($con, "SELECT * FROM users WHERE Email='$email' AND Password='$password' AND role='$role'") or die("Select Error");
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-1">
                        <label class="form-select">User role:</label>
                    </div>
